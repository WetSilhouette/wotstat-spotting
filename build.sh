...
# Set version
configPath="./build/res/scripts/client/gui/mods/wotstatSpotting/WotstatSpotting.py"
perl -i -pe "s/{{VERSION}}/$v/g" "$configPath"

# Set debug mode
utilsPath="./build/res/scripts/client/gui/mods/wotstatSpotting/WotstatSpotting.py"
if [ "$d" = true ]; then
